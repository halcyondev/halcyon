...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\halcyon
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\halcyon
    // Mac: ~/Library/Application Support/halcyon
    // Unix: ~/.halcyon
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "halcyon";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "halcyon.conf"));
