...
unsigned int nStakeMinAge = 60 * 60 * 12 * 1; // 12 hours
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 6400)
    {
        nSubsidy = 150 * COIN;
    }
    else if(pindexBest->nHeight < 6800)
    {
        nSubsidy = 100 * COIN;
    }
    else if(pindexBest->nHeight < 7800)
    {
        nSubsidy = 50 * COIN;
    }
    ...
    else if(pindexBest->nHeight < 19000)
    {
        nSubsidy = 30 * COIN;
    }
    ...
    else if(pindexBest->nHeight < 20001)
    {
        nSubsidy = 100 * COIN;
    }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb761dad6c210bae0a6c1abeec2d7cb83624e34702d3912acba8bef58a932183b"));
        block.print();
